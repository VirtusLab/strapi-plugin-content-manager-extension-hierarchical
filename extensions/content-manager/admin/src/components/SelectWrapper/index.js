...
import { cloneDeep, findIndex, get, isArray, isEmpty, isEqual } from 'lodash';
...
function SelectWrapper({
  ...
  useEffect(() => {
    if(!isEqual(selectedOption, modifiedData[selectedRelationName])){
      setSelectedOption(modifiedData[selectedRelationName])
    }
  }, [modifiedData])
